...
if(with_noise==TRUE){
  ...
  temp_noise <-  sapply(adios$Cod , function(x){rlnorm(1,mean=log(x),sdlog=.35)} ) 
  
  adios$Cod <- temp_noise
...
ifelse(exclude_strata==TRUE, 
       {dir.create(paste(getwd(),"/",scenario,"/Cod/ExcludeStrata",cov_dir,noise_dir,sep=""))
         str_dir <- "ExcludeStrata"},
       {dir.create(paste(getwd(),"/",scenario,"/Cod/AllStrata",cov_dir,noise_dir,sep=""))
         str_dir <- "AllStrata"})


saveRDS(adios,file=paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/adios.RDS",sep=""))
...
covdata <- data.frame(cbind.data.frame(as.numeric(adios[,"Lat"]),as.numeric(adios[,"Lon"]),adios[,"x"],adios[,"y"],adios[,"week"],adios[,"year"],as.numeric(adios[,"Temp"]),as.numeric(adios[,"Hab_Cod"]),adios[,"MoveCov_Cod"],adios[,"Season"]))
...
for(j in 1:6){
  ...
  dir.create(paste(getwd(),"/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/obsmodel",j,sep=""))
  setwd((paste(getwd(),"/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,sep="")))
  ...
  file.rename(from= paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/settings.txt",sep="") 
              ,to =paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/obsmodel",j,"/spring/settings.txt",sep=""))
  
  file.rename(from= paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/parameter_estimates.txt",sep="") 
              ,to =paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/obsmodel",j,"/spring/parameter_estimates.txt",sep=""))
  
  file.rename(from= paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/parameter_estimates.RDATA",sep="") 
              ,to =paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/obsmodel",j,"/spring/parameter_estimates.RDATA",sep=""))
 ...
 # plot_biomass_index(fit_fall)
  ...
  file.rename(from= paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/settings.txt",sep="") 
              ,to =paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/obsmodel",j,"/fall/settings.txt",sep=""))
  
  
  file.rename(from= paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/parameter_estimates.txt",sep="") 
              ,to =paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/obsmodel",j,"/fall/parameter_estimates.txt",sep=""))
  
  file.rename(from= paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/parameter_estimates.RDATA",sep="") 
              ,to =paste(orig.dir,"/VAST/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/obsmodel",j,"/fall/parameter_estimates.RDATA",sep=""))
...
saveRDS(model_aic, file = paste(getwd(),"/",scenario,"/Cod/",str_dir,cov_dir,noise_dir,"/model_aic.RDS",sep=""))
