...
# Estimating Population Trends Under the Pressures of Climate Change
...
```{r temp-scenarios, echo=FALSE,out.width="95%",fig.show='hold', fig.align='center', fig.cap="Mean trends of temperature data used in our MixFishSim population model."}
