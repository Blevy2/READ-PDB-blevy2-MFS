...
225 columns. There are 3*3*2*2*2*2*2 = 288 VAST model combinations and 3*3*2*2*2 = 144
226 stratified mean estimates.}
\centering
\resizebox{\linewidth}{!}{
...
\midrule
Yellowtail & Increasing & Repeating & All strata & No & Spring & \\
Cod & Constant & Increasing 5°C & Subset & Yes & Fall & \\
Haddock & Decreasing &  &  &  &  & \\
\bottomrule
\end{tabular}}
\end{table}
