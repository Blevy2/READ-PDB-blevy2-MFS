...
{\centering \includegraphics[width=0.9\linewidth]{Images/ratio_trend} 

}

\caption{Representative example of typical ratio trend as shown on a log scale.}\label{fig:RatioTrend}
\end{figure}
