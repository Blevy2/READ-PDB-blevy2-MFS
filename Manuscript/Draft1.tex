...
{\centering \includegraphics[width=0.95\linewidth]{Images/PercentPlots_ConPopConTemp_YT} \includegraphics[width=0.95\linewidth]{Images/PercentPlots_ConPopIncTemp_YT} 

}

\caption{add caption}\label{fig:YTpct}
\end{figure}
