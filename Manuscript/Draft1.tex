...
Table \ref{tab:CodERROR} contains the absolute error between our abundance estimates for Cod and the true model values. The VAST different VAST settings produced similar error values with \(18/32\approx57%
