...
\hypertarget{how-might-climate-change-affect-indices-of-abundance-a-simulation-study-starting-point.}{%
\section{How might climate change affect indices of abundance? A simulation study starting point.}\label{how-might-climate-change-affect-indices-of-abundance-a-simulation-study-starting-point.}}
...
\leavevmode\vadjust pre{\hypertarget{ref-ChrisC}{}}%
Christopher Cacciapaglia, C.F.A., Elizabeth N. Brooks. 2023. Developing workflow and diagnostics for model selection of a vector autoregressive spatiotemporal (VAST) model. Fisheries Research \textbf{In Press}. Elsevier.
...
\(F\) & Fishing Mortality & wk\(^{-1}\) & 0.358 & 0.511 & 0.45 & ((NEFSC) 2022) \\
\(W_R\) & Weight of fully recruited fish & kg & 0.39 & 2.95 & 1.12 & ((NEFSC) 2022) \\
\(W_{R-1}\) & Weight of pre-recruit fish & kg & 0.13 & 0.39 & 0.19 & ((NEFSC) 2022) \\
\(\sigma^2\) & Variance in recruited fish & kg\(^2\) & 0.55 & 0.55 & 0.55 & assumed \\
\(\lambda\) & Decay rate for movement & - & 0.7 & 0.7 & 0.7 & assumed \\
\(Spwn_s\) & Spawning weeks for species \(s\) & wk & 9-12 & 8-13 & 11-14 & ((NEFSC) 2022) \\
\(Rec_s\) & Recruitment weeks for species \(s\) & wk & 9-12 & 8-13 & 11-14 & ((NEFSC) 2022) \\
\bottomrule
\end{longtable}
