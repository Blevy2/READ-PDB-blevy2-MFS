...
Figure \@ref(fig:PopPct) depicts the spatial shifting that occurs in our population models in each of the survey weeks.

Of the scenarios without covariates, $33/48\approx68$\% had a VAST fit with a lower relative error compared to the stratified mean estimate. All 15 of the covariate-free VAST estimates that resulted in a higher error than the stratified mean were for the Fall season. These 15 Fall estimates span all other scenario variations and had a common theme of producing abundance estimates that are well above the true model value. Including detailed covariate information made a noticeable difference in our Yellowtail Flounder VAST estimates. Of the VAST estimates that included covariates information, $47/48\approx98$\% had a lower relative error than the corresponding stratified mean estimate. 
...
As seen in Figure \@ref(fig:PopPct), in the constant temperature scenario the Cod population is decreasing its presence in stratas 19 and 20 over the duration of the simulation in both seasons, while simultaneously increasing their presence in strata 16. However, an increase in average temperature had a seasonal impact on Cod's presence in strata 16 in our simulations. In the spring the population followed a similar trend of leaving 19 and 20 while simultaneously entering 16. However, in the fall the increasing temperature drives the population out of strata 16 and 21, and into 18, 22, and 24. **check the impact of this difference on estiamtes**
