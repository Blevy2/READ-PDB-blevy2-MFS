...
```{r CovResponse, echo=FALSE,out.width="105%",fig.show='hold', fig.align='center', fig.cap="Temperature covariate response plots and resulting population estimate for Yellowtail Flounder on the left and Haddock on the right. In both cases the spatial simulations that were surveyed had an increasing population over time, increasing average temperature, and certain strata excluded from sampling, as shown in Figure 1**check**.",out.width="90%"}
# knitr::include_graphics(c("Images/covariate_good.png","Images/covariate_bad.png"))
# knitr::include_graphics(c("Images/covariate_est.png"))

knitr::include_graphics(c("Images/covariate_plot.png"))
