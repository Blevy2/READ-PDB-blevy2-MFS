...
<!-- Paragraph above: Stocks in this region are not managed by NEFSC, they are assessed by us. The management is done by the Councils and GARFO. NEFSC actually only assesses the federally managed stocks (not the state managed stocks like tautog). We also assess some of the invertebrate stocks, such as squid, scallops, ocean quahogs, etc., in addition to fish stocks. Perhaps easier to focus on the bottom trawl itself and replace the first two sentences with something like The NEFSC has conducted a bottom trawl survey since 1963 to support assessment and management of the fish and invertebrate populations in the region (azaorivitz and politis refs).  -->
