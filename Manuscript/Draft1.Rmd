...
#[[note: the library calls can all be made in the first block of R code instead, it sometimes makes it easier to find them if they are all in one place, this approach of defining them within separate blocks works too, just noting a possible different approach]]
...
All data and code used in this work are available at https://github.com/cmlegault/IBMWG. [[need to update this]]
...
param_table1 = read_csv("Cod_results.csv")
