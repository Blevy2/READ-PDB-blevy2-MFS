...
We obtained a shapefile for the 15 strata that comprise George's Bank to use as our modeling environment. We discritized the region into a raster with 88 rows and 144 columns. Haddock inhabit all 15 strata in the domain Cod inhabit 13 strata, and yellowtail exist in 9 strata. **include figure?**
...
**go through each process in model and discuss edits/removals?**


<font size="5">*Temperature and Habitat Input*</font>
...
We obtain estimated temperature data for the region for 2012 from FVCOM **cite**. 
