...
create_spawn_hab_Bens <- function(hab = hab, spwnareas = NULL, mult = 10) {
...
spwn <- define_spawn_Bens(coord = spwnareas, spwn = spwn, mult = mult)

hab.spwn <- hab * spwn
hab.spwn <- hab.spwn / sum(hab.spwn,na.rm=TRUE)
return(hab.spwn)
