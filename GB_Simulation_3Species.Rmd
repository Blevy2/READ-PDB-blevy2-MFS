...
Pop <- init_pop_Bens(sim_init = sim, Bio = c("spp1" = 3194, "spp2" = (13000+30000)/2, "spp3" = 150000*1.2), #CHANGE
                     ...
                     rec_params = list("spp1" = c("model" = "BH", "a" = 30445, "b" = 4301, "cv" = 0),
                                       "spp2" = c("model" = "BH", "a" = 27868 , "b" = 10472, "cv" = 0),
                                       "spp3" = c("model" = "BH", "a" = 73568, "b" = 40530, "cv" = 0)), #CHANGE
...
Pop <- init_pop_Bens(sim_init = sim, Bio = c("spp1" = 3194, "spp2" = (13000+30000)/2, "spp3" = 150000*1.2), #CHANGE
                     ...
                     lambda = c("spp1" = 0, "spp2" = 0, "spp3" = 0), #set at 0 first, change after initial population set
                     init_move_steps = 20,
                     rec_params = list("spp1" = c("model" = "BH", "a" = 40000, "b" = 4301*10, "cv" = 0),
                                       "spp2" = c("model" = "BH", "a" = 45000 , "b" = 10472*6, "cv" = 0),
                                       "spp3" = c("model" = "BH", "a" = 100000, "b" = 40530*10, "cv" = 0)), #CHANGE
                     rec_wk = list("spp1" = 9:12, "spp2" = 8:13, "spp3" = 11:14),
                     spwn_wk = list("spp1" = 9:12, "spp2" = 8:13, "spp3" = 11:14  ), 
...
Rcpp::compileAttributes() #this updates RcppExports.R file, which contains function definitions
  ...
  load("/net/home5/blevy/Bens_R_Projects/READ-PDB-blevy2-MFS2/Results/GB_3species_ConsPop_ConsTemp_environment.RData")
...
#save results
save.image("/net/home5/blevy/Bens_R_Projects/READ-PDB-blevy2-MFS2/Results/GB_3species_ConsPop_ConsTemp_RESULTS.RData")
