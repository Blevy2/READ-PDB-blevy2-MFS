...
Pop <- init_pop_Bens(sim_init = sim, Bio = c("spp1" = 3194, "spp2" = (13000+30000)/2, "spp3" = 150000*1.2), #CHANGE
                     ...
                     init_move_steps = 20,
                     rec_params = list("spp1" = c("model" = "BH", "a" = 108582, "b" = 4301, "cv" = 0),
                                       "spp2" = c("model" = "BH", "a" = 25922 , "b" = 3491, "cv" = 0),
                                       "spp3" = c("model" = "BH", "a" = 157783, "b" = 40530, "cv" = 0)), #CHANGE
                     rec_wk = list("spp1" = 9:12, "spp2" = 8:13, "spp3" = 11:14),
                     spwn_wk = list("spp1" = 9:12, "spp2" = 8:13, "spp3" = 11:14  ), 
                     M = c("spp1" = 1.478+.358, "spp2" = 1.299+.511, "spp3" = 1.097+.7985), #NEED F
                     K = c("spp1" = 1.417, "spp2" = 1.801, "spp3" = 1.422), 
                     nz = nonzero_idx)
