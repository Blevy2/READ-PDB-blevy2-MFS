...
Pop$dem_params$spp2$lambda <- .1
Pop$dem_params$spp3$lambda <- .1
...
Rcpp::compileAttributes() #this updates RcppExports.R file, which contains function definitions
  ...
  load("/net/home5/blevy/Bens_R_Projects/READ-PDB-blevy2-MFS2/Results/GB_3species_IncPop_ConstTemp_environment.RData")
